				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:280px; height:250px;'/>
								</div>
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if(isset($_SESSION["uid"])){
					...
					echo '
						...
						<a class="btn btn-warning" style="float:right;"	href="http://localhost/mystore/success.php"> Place Order</a>';
				}						
				else { 
				echo '
						</form>
